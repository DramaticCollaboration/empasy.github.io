      ...
      <section style={{ padding: '96px 24px', position: 'relative', zIndex: 10, maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ flex: '2 1 280px', color: '#fff', position: 'relative', zIndex: 1 }}>
            <h1 style={{ fontSize: 'clamp(2rem, 4vw, 2.75rem)', fontWeight: 900, marginBottom: '24px', lineHeight: 1.2, color: '#fff' }}>
              {t('hydra.roi.title')}
            </h1>
            <h3>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          >
            ...
            <Link
              ...
              onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 10px 25px rgba(8, 145, 178, 0.35)'; }}
              onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 20px 40px rgba(8, 145, 178,0.2)'; }}
            >
