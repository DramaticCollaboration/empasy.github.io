        ...
        <section className="sa-hero-section">
          ...
          <div className="sa-section-inner sa-hero-inner">
            <div className="sa-hero-text">
              <span className="sa-badge">{t('syncapim.page.badge')}</span>
...
<span className="sa-code-muted">{'}'}</span>
        ...
        <section className="sa-section-inner sa-stats-section">
          ...
          {/* Demo CTA */}
          <div className="sa-cta-box sa-glass-panel">
            <h3 className="sa-cta-title">{t('syncapim.page.ctaTitle')}</h3>
            <p className="sa-cta-desc">{t('syncapim.page.ctaDesc')}</p>
            <div className="sa-cta-form">
              <input
                type="email"
                placeholder={t('syncapim.page.emailPlaceholder')}
                value={email}
