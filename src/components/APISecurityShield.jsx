...
const APISecurityShield = () => {
  ...
  return (
    <div style={{ width: '100%', height: '500px', background: '#020617', borderRadius: '24px', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      {/* Background Grid */}
