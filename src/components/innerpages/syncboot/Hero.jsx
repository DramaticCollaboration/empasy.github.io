import { features6 } from "@/data/syncboot";
          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                Java 기반의 빠른 개발 플랫폼으로, 오픈소스 MSA 아키텍처 위에 기업용 핵심 기능 모듈을 더해 안정적인 시스템 구축 및 운영 효율화를 지원합니다. 개발부터 운영까지 E2E 솔루션을 제공하며, 변화에 민첩하게 대응하도록 돕는 검증된 플랫폼입니다.
              </p>
            </div>
