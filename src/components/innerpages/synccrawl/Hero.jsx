import { features6 } from "@/data/synccrawl";
          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                  SyncCrawl은 자연어 명령으로 웹 콘텐츠를 수집하고, 웹 구조 변경 시 추가 개발 노력을 최소화합니다. LLM의 환각(Hallucination)을 방지하는 RAG 지식 기반을 즉시 구축하여, 정확하고 신뢰도 높은 답변을 제공하는 지능형 통합 크롤링 시스템입니다
              </p>
            </div>
