...
export const features6 = [
  {
    id: 1,
    imgSrc: "/assets/images/product/syncboot/SyncBoot01.jpg",
    imgAlt: "레고처럼 조립하는 시스템! 마이크로서비스 아키텍처",
    title: "레고처럼 조립하는 시스템! 마이크로서비스 아키텍처",
    description: "복잡하고 큰 시스템을 작고 독립적인 서비스로 나눠 개발해요.<br> 필요한 부분만 쏙쏙 골라 수정하거나 확장할 수 있어, 비즈니스 변화에 빠르고 유연하게 대응할 수 있답니다",
    link: null,
  },
  {
    id: 2,
    imgSrc: "/assets/images/product/syncboot/SyncBoot02.png",
    imgAlt: "개발 속도 UP! 핵심 비즈니스에만 집중하세요",
    title: "개발 속도 UP! 핵심 비즈니스에만 집중하세요",
    description:"권한 관리, 대시보드 같은 복잡한 기업용 기능들이 미리 준비되어 있어요..<br> 개발자들은 반복적인 작업 대신, 우리 회사만의 핵심 비즈니스 로직 개발에만 집중할 수 있어 개발 속도가 빨라져요",
    link: null,
  },
  {
    id: 3,
    imgSrc: "/assets/images/product/syncboot/SyncBoot03.png",
    imgAlt: "개발부터 배포, 운영까지 한번에! 올인원 플랫폼",
    title: "개발부터 배포, 운영까지 한번에! 올인원 플랫폼",
    description: "컨테이너 관리, 자동화된 개발/배포(CI/CD), 모니터링, API 관리까지! 시스템 개발과 운영에 필요한 모든 과정을 하나의 플랫폼에서 해결할 수 있어요..<br> DevOps 환경을 쉽게 구축해 보세요",
    link: null,
  },
  {
    id: 4,
    imgSrc: "/assets/images/product/syncboot/SyncBoot04.png",
    imgAlt: "우리 시스템, 잘 돌아가고 있나? 똑똑한 통합 모니터링",
    title: "우리 시스템, 잘 돌아가고 있나? 똑똑한 통합 모니터링",
    description: "서비스 상태부터 시스템 자원 사용 현황, 느리게 작동하는 SQL까지 꼼꼼하게 모니터링해요..<br> 문제가 생기기 전에 미리 파악하고 빠르게 대응해서 안정적인 서비스를 유지할 수 있답니다",
    link: null,
  },
    {
        id: 5,
        imgSrc: "/assets/images/product/syncboot/SyncBoot05.jpg",
        imgAlt: "우리 회사에 딱 맞게! 유연한 오픈소스와 확장성",
        title: "우리 회사에 딱 맞게! 유연한 오픈소스와 확장성",
        description: "특정 기술에 종속되지 않는 오픈소스 기반이라 자유롭게 기술을 도입하고 발전시킬 수 있어요..<br> 또 필요한 기능만 골라 쓰는 모듈식 설계로, 서비스가 성장함에 따라 유연하게 확장할 수 있습니다",
        link: null,
    },
];
