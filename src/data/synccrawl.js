...
export const features6 = [
  {
    id: 1,
    imgSrc: "/assets/images/product/synccrawl/natural_language_smart_commands.png",
    imgAlt: "자연어 지능형 명령",
    title: "자연어 지능형 명령",
    description: "복잡한 코딩 없이 자연어 명령을 입력하면 LangChain4j Agent가 의도를 분석하고 크롤링 Tool 호출을 자동화합니다. 비개발자도 쉽게 웹 콘텐츠 수집 및 분석 명령을 내릴 수 있습니다",
    link: null,
  },
  {
    id: 2,
    imgSrc: "/assets/images/product/synccrawl/automatic_adaptive_system.png",
    imgAlt: "자동 적응형 시스템",
    title: "자동 적응형 시스템",
    description:"Playwright MCP의 자동화된 선택자 재학습 루프를 통해 웹 구조 변경에 유연하게 대응합니다. 500개 이상의 복잡한 웹 환경에서도 안정적인 수집을 보장하여 운영 효율성을 극대화합니다",
    link: null,
  },
  {
    id: 3,
    imgSrc: "/assets/images/product/synccrawl/building_a_rag_knowledge_base.jpg",
    imgAlt: "RAG 지식 기반 구축",
    title: "RAG 지식 기반 구축",
    description: "수집된 데이터는 즉시 RAG 지식 기반으로 변환되어 활용됩니다. 이를 통해 LLM이 환각(Hallucination)하지 않고, 실제 수집된 문서를 기반으로 정확하고 신뢰성 높은 답변을 생성합니다",
    link: null,
  },
  {
    id: 4,
    imgSrc: "/assets/images/product/synccrawl/korean_language_optimization.jpg",
    imgAlt: "한국어 최적화 및 안정성",
    title: "한국어 최적화 및 안정성",
    description: "한국어 데이터에 특화된 모델을 활용하여 높은 품질의 임베딩과 시맨틱 검색을 실현합니다. Spring Boot 기반의 견고한 아키텍처와 실시간 모니터링을 통해 엔터프라이즈급 안정적인 운영을 보장합니다",
    link: null,
  },
];
